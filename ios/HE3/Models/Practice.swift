...
nonisolated enum PracticeData {
    ...
    static let selfPractices: [Practice] = [
        Practice(id: "midday_reset", voice: .selfVoice, title: "The Midday Truth Tap", description: "Once midday, stop and name what you are actually feeling in one word. Not fine, the real word. Naming it quiets the brain's alarm and hands the wheel back to the witness.", icon: "clock.arrow.circlepath"),
